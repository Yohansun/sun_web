; (function($) {
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            ...
            //end tbody
            cpHA.push("</td></tr>");
            cpHA.push("<tr><td class='bbit-dp-bottom' align='center'><button id='BBIT-DP-TODAY' style='background:none;'>", def.btnToday, "</button></td></tr>");
