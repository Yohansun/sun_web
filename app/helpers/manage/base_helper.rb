...
module Manage::BaseHelper
	...
	def nav_path
      ...
      when /channel_tips/
      	'channel_tips'
      when /banner_group|banner_home|banner_channel|banner_refresh|banner_activities|banner_company|banner_images|banner_weekly_stars|banner_other_pages|special_kv/
      	'banner'
  ...
  def left_menu_active key
    flag = case controller_name
      ...
      when (key =~ /channel_tips/) && /channel_tips/
        'on'
      when (key =~ /banner/) && /banner_group|banner_home|banner_channel|banner_refresh|banner_activities|banner_company|banner_images|banner_weekly_stars|banner_other_pages|special_kv/
        'on'
