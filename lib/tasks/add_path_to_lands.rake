# -*- encoding: utf-8 -*-
task :add_path_to_lands => :environment  do
  ...
  urls4 = ["a963shouyejiaodian1",
           "a963shouyeredian1",
           "a963shejishitongdao1"]
  ...
  path_arrays = {"/refresh/home" => urls,
                 "/other_events/review" => urls2,
                 "/" => urls3,
                 "/gift_list" => urls4,
                 "/images" => urls_design_images,
                 "/baicheng" => urls_baicheng,
                 "/channel/access" => urls_channel_access,
                 "/images" => urls_design_imgs,
                 "/weekly_stars-design" => urls_star,
                 "/color_designs" => urls_color_designs,
                 "/master_interviews" => urls_master_designs}

  path_arrays.each do |key,value|
    value.each do |url|
      current_land = LandSource.find_by_code(url)
      if current_land.present?
        current_land.path = key
        current_land.save
        p "#{current_land.path} added"
      end
    end
  end
end