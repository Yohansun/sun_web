...
Icolor::Application.configure do
  ...
  config.assets.precompile += ["famous/*.css","dialog_celebrity/media.css","manage/dialog_celebrity.css","dialog_celebrity/media.js","famous/*.js","manage/dialog_celebrity/*.js"]
